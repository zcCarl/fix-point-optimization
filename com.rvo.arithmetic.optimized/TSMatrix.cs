...
namespace RVO.Arithmetic.Optimized
{
    ...
    public struct TSMatrix
    {
        ...
        private static readonly ConcurrentBag<TSMatrix> _pool = new ConcurrentBag<TSMatrix>();
        ...
        public static TSMatrix Acquire()
        {
        ...
        public static void Release(TSMatrix matrix)
        {
            matrix = Identity;
            _pool.Add(matrix);
        }
